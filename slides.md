...
<div class="absolute" style="bottom: 14%; left: 5%;">
  <p class="tracking-widest text-sm font-bold" style="color: var(--sky);">PROFESSIONAL LEARNING SESSION</p>
  <h1 class="font-head text-5xl font-bold mt-3" style="color: white;">From Disrupting to Driving</h1>
  <p class="text-lg italic mt-3" style="color: #CFE0EB; max-width: 40rem;">Reimagining Student Engagement as a Continuum of Learning Behaviors</p>
  <p class="text-sm mt-2" style="color: #B9CEE0;">Education Services &nbsp;|&nbsp; Upper Secondary Faculty &nbsp;|&nbsp; Academic Reading & Writing Program</p>
</div>
...
<div class="absolute top-0 left-0 w-full" style="height: 1.15in; background: var(--navy);"></div>
<div class="absolute top-0 left-0 w-full" style="top: 1.15in; height: 0.09in; background: var(--sky);"></div>

<h1 class="font-head text-3xl font-bold absolute" style="top: 0.3in; left: 0.5in; color: white;">WHY THIS MATTERS — EVEN AFTER YEARS IN THE CLASSROOM</h1>

<div class="absolute" style="top: 1.6in; left: 0.5in; right: 0.5in;">
<p class="italic" style="color: var(--muted); max-width: 50rem;">You already know engagement when you see it. This session gives us shared, precise language for it — and shows what 158 students told researchers about it directly.</p>
...
<div class="grid grid-cols-3 gap-6 mt-8">
  ...
  ]" :key="it.title" class="rounded-lg p-5" :style="{ background: 'var(--offwhite)', border: `1px solid ${it.color}` }">
    <div class="w-14 h-14 rounded-full flex items-center justify-center mb-3" :style="{ background: it.color }">
      <Icon :name="it.icon" :size="26" color="white" />
    </div>
    <h3 class="font-head text-base font-bold" style="color: var(--navy);">{{ it.title }}</h3>
    <p class="text-sm mt-2">{{ it.body }}</p>
  </div>
</div>
</div>
...
<div class="absolute top-0 left-0 w-full" style="height: 1.15in; background: var(--navy);"></div>
<div class="absolute top-0 left-0 w-full" style="top: 1.15in; height: 0.09in; background: var(--tan);"></div>

<h1 class="font-head text-3xl font-bold absolute" style="top: 0.3in; left: 0.5in; color: white;">THE RESEARCH BEHIND THE FRAMEWORK</h1>

<div class="grid grid-cols-2 gap-6 absolute" style="top: 1.6in; left: 0.5in; right: 0.5in;">
  <div class="rounded-lg p-6" style="background: white; border: 1px solid var(--navy); box-shadow: 0 3px 10px rgba(0,0,0,.08);">
    <div class="w-16 h-16 rounded-full flex items-center justify-center mb-4" style="background: var(--navy);">
      <Icon name="Microscope" :size="30" color="white" />
    </div>
    <h3 class="font-head text-xl font-bold" style="color: var(--navy);">Dr Amy Berry</h3>
    <p class="italic text-sm" style="color: var(--muted);">Research Fellow, ACER &nbsp;|&nbsp; Honorary Fellow, University of Melbourne</p>
    <p class="text-sm mt-4 leading-relaxed">20+ years in education as classroom teacher, researcher, and professional learning facilitator.</p>
    <p class="text-sm mt-3 leading-relaxed">10 years teaching in Queensland, Australia, before moving into research on engagement and teacher professional learning.</p>
    <p class="text-sm mt-3 leading-relaxed">Has worked with teachers and education systems in the U.S., Saudi Arabia, Singapore, Indonesia, the Philippines, and Ukraine.</p>
  </div>

  <div class="rounded-lg p-6" style="background: var(--navy);">
    <h3 class="font-head text-lg font-bold" style="color: var(--sky);">HOW THE FRAMEWORK WAS BUILT</h3>
    <div class="mt-5">
      <p class="font-bold" style="color: var(--tan);">2016–17</p>
      <p class="text-sm mt-1" style="color: #DCE6EF;">In-depth interviews with classroom teachers exploring how they described and recognized student engagement — both everyday and rare, powerful examples.</p>
    </div>
    <div class="mt-5">
      <p class="font-bold" style="color: var(--tan);">2020</p>
      <p class="text-sm mt-1" style="color: #DCE6EF;">Fisher, Frey & Hattie included the continuum in <em>The Distance Learning Playbook</em>, extending it into remote learning.</p>
    </div>
    <div class="mt-5">
      <p class="font-bold" style="color: var(--tan);">2024–25</p>
      <p class="text-sm mt-1" style="color: #DCE6EF;">Berry and Dr Kellie Picker ran ACER focus groups with 158 students, Prep to Year 12, asking students directly about their own engagement.</p>
    </div>
  </div>
</div>
...
<div class="absolute top-0 left-0 w-full" style="height: 1.05in; background: var(--navy);"></div>
<div class="absolute top-0 left-0 w-full" style="top: 1.05in; height: 0.09in; background: var(--sky);"></div>

<h1 class="font-head text-2xl font-bold absolute" style="top: 0.28in; left: 0.5in; color: white;">A NEW VOCABULARY: THE ENGAGEMENT CONTINUUM</h1>
<p class="italic absolute text-sm" style="top: 1.3in; left: 0.5in; color: var(--muted);">Six forms of engagement — not a simple on/off switch</p>

<div class="grid grid-cols-6 gap-3 absolute" style="top: 2.0in; left: 0.5in; right: 0.5in;">
  <div v-for="s in [
    ...
    <div class="w-14 h-14 mx-auto rounded-full flex items-center justify-center mb-3" :style="{ background: s.color }">
      <Icon :name="s.icon" :size="24" color="white" />
    </div>
    <p class="font-head font-bold text-sm" style="color: var(--navy);">{{ s.label }}</p>
    <p class="text-xs italic mt-1" style="color: var(--muted);">{{ s.sub }}</p>
  </div>
</div>

<div class="flex justify-between absolute text-sm font-bold" style="top: 5.7in; left: 0.5in; right: 0.5in;">
  <span style="color: var(--gray);">◀ DISENGAGING FROM LEARNING</span>
  <span style="color: var(--navy2);">ENGAGING IN LEARNING ▶</span>
</div>

<p class="text-xs italic absolute" style="bottom: 0.3in; left: 0.5in; color: var(--muted);">Original continuum diagram concept: Berry (2023, 2022). Recreated for instructional use.</p>
...
<p class="italic mt-2" style="color: #9FB6CC;">Passive withdrawal → active avoidance → active disruption</p>
...
<div class="mt-8 space-y-4">
  ...
  ]" :key="r.title" class="rounded-lg p-4 flex items-center gap-5" style="background: #0B3663;">
    <div class="w-16 h-16 flex-shrink-0 rounded-full flex items-center justify-center" style="background: var(--gray);">
      <Icon :name="r.icon" :size="28" color="white" />
    </div>
    <div>
      <h3 class="font-head text-lg font-bold" style="color: var(--sky);">{{ r.title }}</h3>
      <p class="text-sm mt-1" style="color: #DCE6EF;">{{ r.body }}</p>
    </div>
  </div>
</div>
...
<p class="italic mt-2" style="color: var(--muted);">Compliant participation → genuine investment → self-directed driving</p>
...
<div class="mt-8 space-y-4">
  ...
  ]" :key="r.title" class="rounded-lg p-4 flex items-center gap-5" style="background: var(--offwhite); box-shadow: 0 2px 8px rgba(0,0,0,.06);">
    <div class="w-16 h-16 flex-shrink-0 rounded-full flex items-center justify-center" :style="{ background: r.color }">
      <Icon :name="r.icon" :size="28" color="white" />
    </div>
    <div>
      <h3 class="font-head text-lg font-bold" style="color: var(--navy);">{{ r.title }}</h3>
...
<div class="flex justify-center">
  <div class="w-20 h-20 rounded-full flex items-center justify-center" style="background: var(--sky);">
    <Icon name="ArrowLeftRight" :size="36" color="white" />
  </div>
</div>
<h1 class="font-head text-2xl font-bold text-center mt-6">THE KEY INSIGHT FOR VETERAN TEACHERS</h1>

<div class="rounded-lg p-8 mt-8 text-center" style="background: #0B3663; border: 1px solid var(--sky); max-width: 50rem; margin-left: auto; margin-right: auto;">
  <p class="font-head text-xl font-bold" style="color: var(--sky);">The most ACTIVE behaviors sit at BOTH ends of the continuum.</p>
  <p class="mt-4" style="color: #DCE6EF;">The most PASSIVE behaviors — Withdrawing and Participating — sit in the middle, not at the "calm" end.</p>
</div>

<div class="mt-8" style="max-width: 50rem; margin-left: auto; margin-right: auto;">
  <p class="font-bold" style="color: var(--tan);">What this means for our classrooms:</p>
  <ul class="mt-3 space-y-2 text-sm" style="color: #DCE6EF;">
...
<h1 class="font-head text-2xl font-bold">INSIDE DISENGAGEMENT: WHAT STUDENTS REPORTED</h1>
<p class="italic mt-2 text-sm" style="color: #9FB6CC;">Part 3 of the ACER series — "Student Voice on Engagement Roadblocks" (Berry & Picker, 2025)</p>

<div class="grid grid-cols-2 gap-6 mt-8">
  <div class="rounded-lg p-6" style="background: #0B3663;">
    <div class="w-14 h-14 rounded-full flex items-center justify-center mb-3" style="background: var(--gray);">
      <Icon name="AlertTriangle" :size="26" color="white" />
    </div>
    <h3 class="font-head font-bold" style="color: var(--sky);">What disengagement looks like</h3>
    <ul class="mt-4 space-y-2 text-sm" style="color: #DCE6EF;">
  ...
  <div class="rounded-lg p-6" style="background: #0B3663;">
    <div class="w-14 h-14 rounded-full flex items-center justify-center mb-3" style="background: var(--tan);">
      <Icon name="Search" :size="26" color="white" />
    </div>
    <h3 class="font-head font-bold" style="color: var(--sky);">Root causes students named</h3>
    <ul class="mt-4 space-y-2 text-sm" style="color: #DCE6EF;">
    ...
    <div class="rounded-md p-3 mt-4" style="background: var(--navy2);">
      <p class="text-xs italic" style="color: #E4EEF6;">"Asking students what is making it hard is a better option than assuming we know what is going on."</p>
    </div>
  </div>
</div>
...
<h1 class="font-head text-2xl font-bold" style="color: var(--navy);">APPLYING THIS IN OUR UPPER-SECONDARY ELA CLASSROOM</h1>
<p class="italic mt-2 text-sm" style="color: var(--muted);">A DOK 3–4 activity idea for dual-credit / advanced courses</p>

<div class="grid grid-cols-2 gap-6 mt-8">
  <div class="rounded-lg p-6" style="background: var(--offwhite); border: 1px solid var(--navy2); box-shadow: 0 2px 8px rgba(0,0,0,.06);">
    <div class="w-14 h-14 rounded-full flex items-center justify-center mb-3" style="background: var(--navy);">
      <Icon name="Pencil" :size="26" color="white" />
    </div>
    <h3 class="font-head font-bold" style="color: var(--navy);">Student self-location + justification</h3>
    <p class="text-sm mt-4 leading-relaxed">During a rhetorical analysis or revision task, students identify where they landed on the continuum and cite evidence from their own process.</p>
    <p class="text-sm mt-4 italic leading-relaxed">Prompt: "Were you participating, investing, or driving during this task? Justify your placement with two specific behaviors, then name one action that would move you one step further."</p>
  </div>
  <div class="rounded-lg p-6" style="background: var(--offwhite); border: 1px solid var(--tan); box-shadow: 0 2px 8px rgba(0,0,0,.06);">
    <div class="w-14 h-14 rounded-full flex items-center justify-center mb-3" style="background: var(--tan);">
      <Icon name="ClipboardList" :size="26" color="white" />
    </div>
    <h3 class="font-head font-bold" style="color: var(--navy);">Teacher audit of assignment design</h3>
...
<h1 class="font-head text-2xl font-bold absolute text-white" style="top: 0.4in; right: 0.6in; text-align: right;">FACULTY DISCUSSION</h1>

<div class="absolute space-y-4" style="top: 1.5in; left: 1.3in; right: 1.3in;">
  <div v-for="(q, i) in [
...
<div class="absolute top-0 left-0 w-full" style="height: 1.05in; background: var(--navy);"></div>
<div class="absolute top-0 left-0 w-full" style="top: 1.05in; height: 0.09in; background: var(--tan);"></div>

<h1 class="font-head text-3xl font-bold absolute" style="top: 0.28in; left: 0.5in; color: white;">REFERENCES</h1>
<p class="italic text-sm absolute" style="top: 1.2in; left: 0.5in; color: var(--muted);">APA 7th edition</p>

<div class="absolute space-y-5 text-sm" style="top: 1.8in; left: 0.9in; max-width: 56rem;">
...
<img src="/ssusd_logo.png" class="absolute" style="bottom: 0.4in; right: 0.6in; width: 1.9in;" />
<p class="text-xs italic absolute" style="bottom: 0.4in; left: 0.9in; color: var(--muted);">Icons: Lucide (ISC License), lucide.dev — open-source icon library, used under license.</p>
