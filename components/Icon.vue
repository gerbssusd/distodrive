<script setup>
// Self-contained icon component: Lucide SVG path bodies are baked in directly
// so no external icon package (@iconify-json/lucide) is needed at build time.
...
const paths = {
    ...
    DoorOpen: `<path d="M13 4h3a2 2 0 0 1 2 2v14"></path><path d="M2 20h3"></path><path d="M13 20h9"></path><path d="M10 12v.01"></path><path d="M13 4.562v16.157a1 1 0 0 1-1.242.97L5 20V5.562a2 2 0 0 1 1.515-1.94l4-1A2 2 0 0 1 13 4.561Z"></path>`,
    ...
    ArrowLeftRight: `<path d="M8 3 4 7l4 4"></path><path d="M4 7h16"></path><path d="m16 21 4-4-4-4"></path><path d="M20 17H4"></path>`,
